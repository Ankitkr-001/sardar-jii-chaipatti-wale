...
export const CATEGORIES: Category[] = [
  {
    ...
    image: 'https://via.placeholder.com/400x300?text=Black+Tea',
    productCount: 3,
  },
  {
    id: 'cat-2',
    ...
    image: 'https://via.placeholder.com/400x300?text=Green+Tea',
    productCount: 2,
  },
  {
    id: 'cat-3',
    ...
    image: 'https://via.placeholder.com/400x300?text=Herbal+Tea',
    productCount: 2,
  },
  {
    id: 'cat-4',
    ...
    image: 'https://via.placeholder.com/400x300?text=Specialty+Tea',
    productCount: 2,
  },
];
...
export const PRODUCTS: Product[] = [
  {
    ...
    comparePrice: 799,
    images: [
      'https://via.placeholder.com/600x600?text=Darjeeling+First+Flush',
      'https://via.placeholder.com/600x600?text=Darjeeling+Tea+Leaves',
    ],
    category: 'Black Tea',
    categoryId: 'cat-1',
    stock: 50,
  ...
  },
  {
    ...
    comparePrice: 399,
    images: [
      'https://via.placeholder.com/600x600?text=Assam+CTC+Bold',
      'https://via.placeholder.com/600x600?text=Assam+Tea',
    ],
    category: 'Black Tea',
    categoryId: 'cat-1',
    stock: 100,
  ...
  },
  {
    ...
    comparePrice: 599,
    images: [
      'https://via.placeholder.com/600x600?text=Masala+Chai+Blend',
      'https://via.placeholder.com/600x600?text=Masala+Spices',
    ],
    category: 'Specialty',
    categoryId: 'cat-4',
    stock: 75,
  ...
  },
  {
    ...
    comparePrice: 649,
    images: [
      'https://via.placeholder.com/600x600?text=Himalayan+Green+Tea',
      'https://via.placeholder.com/600x600?text=Green+Tea+Leaves',
    ],
    category: 'Green Tea',
    categoryId: 'cat-2',
    stock: 60,
  ...
  },
  {
    ...
    comparePrice: 899,
    images: [
      'https://via.placeholder.com/600x600?text=Kashmiri+Kahwa',
      'https://via.placeholder.com/600x600?text=Saffron+Tea',
    ],
    category: 'Specialty',
    categoryId: 'cat-4',
    stock: 30,
  ...
  },
  {
    ...
    comparePrice: 699,
    images: [
      'https://via.placeholder.com/600x600?text=Nilgiri+Oolong',
      'https://via.placeholder.com/600x600?text=Oolong+Tea',
    ],
    category: 'Specialty',
    categoryId: 'cat-4',
    stock: 25,
  ...
  },
  {
    ...
    comparePrice: 999,
    images: [
      'https://via.placeholder.com/600x600?text=Silver+Needle+White+Tea',
      'https://via.placeholder.com/600x600?text=White+Tea+Buds',
    ],
    category: 'Specialty',
    categoryId: 'cat-4',
    stock: 20,
  ...
  },
  {
    ...
    comparePrice: 449,
    images: [
      'https://via.placeholder.com/600x600?text=Tulsi+Ginger+Blend',
      'https://via.placeholder.com/600x600?text=Herbal+Wellness',
    ],
  ...
  },
  {
    ...
    comparePrice: 499,
    images: [
      'https://via.placeholder.com/600x600?text=Chamomile+Lavender',
      'https://via.placeholder.com/600x600?text=Sleep+Blend',
    ],
    category: 'Herbal & Wellness',
    categoryId: 'cat-3',
    stock: 55,
  ...
  },
  {
    ...
    comparePrice: 599,
    images: [
      'https://via.placeholder.com/600x600?text=Jasmine+Pearl+Tea',
      'https://via.placeholder.com/600x600?text=Jasmine+Flowers',
    ],
    category: 'Green Tea',
    categoryId: 'cat-2',
    stock: 40,
