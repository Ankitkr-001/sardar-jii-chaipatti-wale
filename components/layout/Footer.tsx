        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              {/* Facebook */}
              <a href="#" aria-label="Facebook" className="w-11 h-11 sm:w-9 sm:h-9 bg-white/10 hover:bg-accent hover:text-dark rounded-full flex items-center justify-center transition-all duration-200">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>
              </a>
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="w-11 h-11 sm:w-9 sm:h-9 bg-white/10 hover:bg-accent hover:text-dark rounded-full flex items-center justify-center transition-all duration-200">
              ...
              {/* Twitter */}
              <a href="#" aria-label="Twitter" className="w-11 h-11 sm:w-9 sm:h-9 bg-white/10 hover:bg-accent hover:text-dark rounded-full flex items-center justify-center transition-all duration-200">
              ...
              {/* YouTube */}
              <a href="#" aria-label="YouTube" className="w-11 h-11 sm:w-9 sm:h-9 bg-white/10 hover:bg-accent hover:text-dark rounded-full flex items-center justify-center transition-all duration-200">
